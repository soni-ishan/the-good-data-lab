      ...
      <div className="mx-auto flex h-20 w-full max-w-7xl items-center justify-between px-6 sm:px-8 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex" aria-label="Primary">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-[#c4a24a]/45 bg-[#c4a24a]/20 px-4 py-2 text-sm font-semibold text-[#fff7e6] transition hover:bg-[#c4a24a]/30"
          >
